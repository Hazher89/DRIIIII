              ...
              SliverToBoxAdapter(
                child: SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      QuickActionButton(icon: AppIcons.absence, label: 'Fravær', color: DriftProTheme.absenceVacation, onTap: () => widget.onNavigate?.call(1)),
                      const SizedBox(width: 12),
                      QuickActionButton(icon: AppIcons.newTicket, label: 'Nytt avvik', color: DriftProTheme.warning, onTap: () => widget.onNavigate?.call(2)),
                      const SizedBox(width: 12),
                      QuickActionButton(icon: AppIcons.sja, label: 'Ny SJA', color: DriftProTheme.accentBlue, onTap: () => widget.onNavigate?.call(3)),
                      const SizedBox(width: 12),
                      QuickActionButton(icon: AppIcons.riskAssessment, label: 'Risiko', color: DriftProTheme.riskHigh, onTap: () => widget.onNavigate?.call(3)),
                    ],
                  ),
                ),
              ),
              ...
              SliverPadding(
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildListDelegate([
                    StatCard(title: 'Fravær i dag', value: '${_stats.todayAbsences}', icon: AppIcons.absence, color: DriftProTheme.absenceVacation, onTap: () => widget.onNavigate?.call(1)),
                    StatCard(title: 'Åpne avvik', value: '${_stats.openTickets}', icon: AppIcons.ticket, color: DriftProTheme.warning, subtitle: '${_stats.criticalTickets} kritiske', isAlert: _stats.criticalTickets > 0, onTap: () => widget.onNavigate?.call(2)),
                  ]),
                ),
              ),
