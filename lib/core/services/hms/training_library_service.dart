...
class TrainingLibraryService {
  ...
  static const docs = <TrainingDocMeta>[
    ...
    TrainingDocMeta(
      id: 'gm_storo_uniform',
      title: 'GM & STORO / Uniform / Kamera',
      subtitle: 'Label-skann, uniform-monitor og vision',
      assetPath: 'assets/hms/training/guides/driftpro_gm_storo_uniform.txt',
      kind: TrainingDocKind.plainText,
      tags: [
        'gm',
        'storo',
