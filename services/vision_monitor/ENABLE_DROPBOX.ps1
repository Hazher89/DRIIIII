...
$envText = Set-EnvLine $envText "CLIP_SECONDS_BEFORE" "30"
$envText = Set-EnvLine $envText "CLIP_SECONDS_AFTER" "30"
...
Write-Host "  CLIP: 30s for person + 30s etter avgang (kun feilkasting)"
